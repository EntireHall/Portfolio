...
const Form = () => {
    ...
    return (
        ...
        <form onSubmit={handleSubmit} autoComplete='off' className=' border-2 border-green-700  flex flex-col flex-wrap p-10  mt-10 text-slate-200 ' >
            ...
            <button type="submit" className=' mt-10 w-40 rounded text-zinc-900 font-semibold bg-green-700 p-2  text-lg transition ease-in duration-300 delay-200 hover:text-green-700 hover:bg-transparent hover:border-2 hover:border-green-700 '>Send</button>
</div>
        </form>
