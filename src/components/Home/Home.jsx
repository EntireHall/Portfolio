...
function Button1({ icon, title,title1 }) {
  return <div className="flex gap-2 items-center rounded text-black  px-4 py-2 bg-green-800 font-bold hover:bg-transparent hover:border-green-700 hover:border hover:text-green-700">
      <span>{icon}</span>
    <button>{title1}</button>
  </div>
}
    ...
    <div className='flex bg-zinc-950  min-h-screen justify-center items-center md:px-28 '>
      ...
      <div className=' flex flex-col items-left md:pl-20 md:w-[70%] max-sm:pl-10'>
            ...
            <div className='flex justify-center px-7 font-bold text-slate-400 font-pop flex-col' >
              ...
              <h1 className='text-6xl'>Hi,I'm Kartik</h1></div>
             
              <div className='flex  px-7 font-bold text-slate-400 font-pop flex-col p-8 text-4xl '>
             <h1 className='flex gap-2 '>I am a <span className='text-green-700'><Type/></span></h1>
              </div>
