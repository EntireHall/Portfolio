...
export default function About() {
  return (
<>
        <div className='min-h-screen flex justify-center items-center bg-zinc-950 md:pl-[15%] max-sm:px-4 mix-blend-screen'>

        <div className='w-[30%]  max-sm:hidden'>
                       <img src={avatar3} className='h-[500px] w-[350px]' />
          </div> 

          <div className=' flex flex-col items-left md:pl-20 md:w-[70%]  max-sm:pt-10'>
          <h1 className='text-5xl font-semibold pb-6 text-green-700 pl-6'>About Me</h1>   
          
          <p className=' text-lg font-pop text-slate-300 md:pr-[30%] text-justify px-4  pb-4'>I am a punctual and motivated individual who is able
      ...
      <div className='md:pl-60 max-sm:pl-24  mb-4'>
      <Link to="/resume">
