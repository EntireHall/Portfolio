...
function Li({ link, title }) {
    return <Link to={link} className="font-semibold text-green-800 hover:underline underline-offset-4 max-sm:pr-40">
    ...
    return (
        ...
        <div className=" flex justify-around p-4 bg-zinc-950 shadow-md shadow-gray-500 font-pop  "> 
               ...
               <h1 className=' font-bold text-slate-200 text-2xl animate-pulse w-full px-4 font-Aer'>Portfoilio.</h1>
                ...
                <ul className={` md:flex md:justify-end gap-10 md:w-full text-lg px-6  ${show ? "sm:flex  md:border-hidden mt-14  ": "hidden "}` }>
                    <Li link={"/"} title={"Home"} />
